 ...
 * @return {h5.modbus.functions.ReadCoilsRequest} A response created from the specified `options`.
 ...
 * @return {h5.modbus.functions.ReadCoilsRequest} A request created from its binary representation.
