 ...
 * @throws {Error} If the length of the `statuses` array is not between 1 and 2000.
 */
 ...
 * @return {h5.modbus.functions.ReadDiscreteInputsResponse} A response created from the specified `options`.
 ...
 * @return {h5.modbus.functions.ReadDiscreteInputsResponse} A response created from its binary representation.
