...
ReadFileRecordResponse.prototype.toBuffer = function()
{
  ...
  var subResponsesLength = this.getSubResponsesLength();
...
/**
 * @returns {number} A byte length of the all sub-responses.
 */
ReadFileRecordResponse.prototype.getSubResponsesLength = function()
{
