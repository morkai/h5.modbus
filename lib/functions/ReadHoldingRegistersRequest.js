 ...
 *
 * @name h5.modbus.functions.ReadHoldingRegistersRequest
 * @constructor
 ...
 *     A quantity of registers. If specified, must be a number between 1 and 125.
 *     Defaults to 1.
 *
 * @param {object} options An options object.
 * @param {number=} options.address
 * @param {number=} options.quantity
 * @return {h5.modbus.functions.ReadHoldingRegistersRequest} A request created from the specified `options`.
 ...
 * @return {h5.modbus.functions.ReadHoldingRegistersRequest} A request created from its binary representation.
...
/**
 * @return {number} A quantity of registers.
 */
