 ...
 * @param {number} quantity A quantity of input registers. Must be between 1 and 125.
 ...
 * @return {h5.modbus.functions.ReadInputRegistersRequest} A request created from the specified `options`.
 ...
 * @return {h5.modbus.functions.ReadInputRegistersRequest} A request created from its binary representation.
...
/**
 * @return {number} A quantity of input registers.
 */
