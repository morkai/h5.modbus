 ...
 * @throws {Error} If the `values` is not a Buffer of even length between 2 and 250.
 */
 ...
 * @return {h5.modbus.functions.ReadInputRegistersResponse} A response created from the specified `options`.
 ...
 * @return {h5.modbus.functions.ReadInputRegistersResponse} Read input registers response.
