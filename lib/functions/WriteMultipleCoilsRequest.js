 ...
 *
 * @name h5.modbus.functions.WriteMultipleCoilsRequest
 * @constructor
 * @extends {h5.modbus.functions.Request}
 * @param {number} address A starting address. A number between 0 and 0xFFFF.
 * @param {Array.<boolean>} states States of the coils. An array of 1 and 1968 truthy or falsy values.
 ...
 *     States of the coils. Must be an array of 1 to 1968 truthy or falsy values.
 *
 * @param {object} options An options object.
 * @param {number} options.address
 * @param {Array.<boolean>} options.states
 * @return {h5.modbus.functions.WriteMultipleCoilsRequest} A response created from the specified `options`.
 ...
 * @return {h5.modbus.functions.WriteMultipleCoilsRequest} A request created from its binary representation.
...
/**
 * @return {Array.<boolean>} States of the coils.
 */
