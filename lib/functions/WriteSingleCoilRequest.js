 ...
 *
 * @name h5.modbus.functions.WriteSingleCoilRequest
 * @constructor
 * @extends {h5.modbus.functions.Request}
 * @param {number} address An output address. A number between 0 and 0xFFFF.
 * @param {boolean} state A state of the coil. `TRUE` - coil is ON; `FALSE` - coil is OFF.
 ...
 * @return {h5.modbus.functions.WriteSingleCoilRequest} A response created from the specified `options`.
 ...
 * @return {h5.modbus.functions.WriteSingleCoilRequest} A request created from its binary representation.
...
/**
 * @return {number} An output address.
 */
...
/**
 * @return {boolean} A state of the coil.
 */
