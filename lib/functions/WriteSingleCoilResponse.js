 ...
 * @param {number} address An address of the output. Must be between 0x0000 and 0xFFFF.
 * @param {boolean} state A state of the output. `TRUE` - the coil is ON; `FALSE` - the coil is OFF.
 ...
 * @return {h5.modbus.functions.WriteSingleCoilResponse} A request created from its binary representation.
