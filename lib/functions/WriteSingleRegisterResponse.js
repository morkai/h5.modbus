 ...
 *
 * @name h5.modbus.functions.WriteSingleRegisterResponse
 * @constructor
 * @extends {h5.modbus.functions.Response}
 * @param {number} address An address of the register. Must be between 0x0000 and 0xFFFF.
 ...
 * @return {h5.modbus.functions.WriteSingleRegisterResponse} A request created from its binary representation.
...
/**
 * @return {number} An address of the register.
 */
