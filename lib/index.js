...
var transportFactories = {
  ...
  {
    return new (require('./transports/IpTransport'))(createConnection(options.connection));
  },
  'ascii': function createAsciiTransport(options)
  {
    return new (require('./transports/AsciiTransport'))(createConnection(options.connection));
  },
...
function createMaster(options)
{
  ...
  return new Master(new Master.Options(options));
}
