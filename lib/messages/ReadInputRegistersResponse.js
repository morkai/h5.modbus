 ...
 */
class ReadInputRegistersResponse extends Response
{
  /**
   ...
   * @returns {ReadInputRegistersResponse}
   * @throws {Error} If any of the specified `options` are invalid.
   */
  static fromOptions(options)
  {
    return new ReadInputRegistersResponse(options.data);
  }
  ...
  static fromBuffer(buffer)
  {
    ...
    return new ReadInputRegistersResponse(data);
  }
  ...
  toString()
  {
    return helpers.formatResponse(this, `${this.quantity} input registers: ${inspect(this.data)}`);
  }
}
